...
rm -f "/system/framework/com.sonyericsson.idd_impl.jar"
...
rm -f "/system/framework/com.sonyericsson.updatecenter.jar"
...
rm -f "/system/framework/com.sonymobile.product_impl.jar"
...
rm -f "/system/lib/libaudioeffect_jni.so"
...
rm -f "/system/lib/libDynamicNormalizer.so"
...
rm -rf "/system/priv-app/SoundEnhancement"
...
cp -rf "/data/quasar-atmox/backup/etc/sforce" "/system/etc/sforce"
...
cp -f "/data/quasar-atmox/backup/framework/com.sonyericsson.idd_impl.jar" "/system/framework/"
...
cp -f "/data/quasar-atmox/backup/framework/com.sonyericsson.updatecenter.jar" "/system/framework/"
...
cp -f "/data/quasar-atmox/backup/framework/com.sonymobile.product_impl.jar" "/system/framework/"
...
cp -f "/data/quasar-atmox/backup/lib/libaudioeffect_jni.so" "/system/lib/"
...
cp -f "/data/quasar-atmox/backup/lib/libDynamicNormalizer.so" "/system/lib/"
...
cp -rf "/data/quasar-atmox/backup/priv-app/ViPER4AndroidFX-2.5.0.5" "/system/priv-app/ViPER4AndroidFX-2.5.0.5"
